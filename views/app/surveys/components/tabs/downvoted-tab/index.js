...
class DownvotedTab extends Component {
  constructor(props) {
    super(props);
    this.state = {
      params: {},
    ...
    this.props.dispatch(
      downloadSurveyLoser(
        ...
        (res) => {
          ...
          link.href = url;
          link.setAttribute("download", "downvoted.csv");
...
export default connect(mapStateToProps)(withRouter(DownvotedTab));
