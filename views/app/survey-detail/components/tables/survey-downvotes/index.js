...
class SurveyDownVotesTable extends Component {
  constructor(props) {
    super(props);
    this.state = {
      loading: false,
  ...
  openFullPageView() {
    ...
    history.push(`/app/surveys/${this.props.id}/full-page?status=downvoted`);
  }
    ...
    this.props.dispatch(
      downloadCurrentDownvoteByProposal(
        ...
        (res) => {
          ...
          link.href = url;
          link.setAttribute("download", "downvote-survey.csv");
      ...
      <>
        <div className="app-infinite-search-wrap">
          <div className="d-flex align-items-center">
            <h4 className="pr-2">Current downvotes by proposal</h4>
...
export default connect(mapStateToProps)(withRouter(SurveyDownVotesTable));
