...
class BidsVotesTable extends Component {
  constructor(props) {
    super(props);
    this.state = {
      loading: false,
      ...
      downloadCurrentBidVote(
        ...
        (res) => {
          if (res.type === "application/json" || res.success === false) {
            ...
            link.href = url;
            link.setAttribute("download", "rfp-survey.csv");
      ...
      <>
        <div className="app-infinite-search-wrap">
          <div className="d-flex align-items-center">
            <h4 className="pr-2">Votes for each bid</h4>
...
export default connect(mapStateToProps)(withRouter(BidsVotesTable));
