        ...
        <div className="infinite-contentInner">
          <div className="infinite-header">
            <div className="infinite-headerInner">
              ...
              <div className="c-col-2 c-cols">
                <label className="font-size-14">Results</label>
              </div>
              <div className="c-col-3 c-cols">
              ...
              <div className="c-col-5 c-cols">
                <label className="font-size-14">Participation</label>
              </div>
            </div>
          </div>
...
export default connect(mapStateToProps)(withRouter(CompletedSurveysTable));
